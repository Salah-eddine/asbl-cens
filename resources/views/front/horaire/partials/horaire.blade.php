    ...
    <div class="container">
        <div class="row">
            <div class="text-center filters col-sm-12">
                <ul id="timetable_filter" class="greylinks">
                    <li> <a data-filter="all" href="#" class="selected">All</a> </li>
                ...
                <div class="table-responsive">
                    <table class="table_template darklinks" id="timetable">
                        ...
                        <tbody>
                            <tr>
                                <th>8:00 - 9:00</th>
                                <td> <a href="event-single-left.html" class="management">
                            Management
                        </a> </td>
                                <td> <a href="event-single-left.html" class="meetings">
                            Meetings
                        </a> </td>
                                <td> </td>
                                <td> <a href="event-single-left.html" class="consultations">
                            Consultations
                        </a> </td>
                                <td> <a href="event-single-left.html" class="presentations">
                            Presentations
                        </a> </td>
                                <td> <a href="event-single-left.html" class="management">
                            Management
                            ...
                            <tr>
                                <th>9:00 - 10:00</th>
                                <td> </td>
                                <td> <a href="event-single-left.html" class="training">
                            Training
                        </a> </td>
                                <td> <a href="event-single-left.html" class="presentations">
                            Presentations
