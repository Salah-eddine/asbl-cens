...
@section('content')
<form method="POST" action="{{route("citation.update",["citation"=>$citation->id])}}">
 @method("PUT")
  @csrf
      ...
      @endif
        <input value="{{old("auteur")}}" name="auteur" type="text" class=" bg-white form-control " id="exampleInputPassword1" placeholder="Auteur">
        </div>
